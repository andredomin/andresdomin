...
Se utilizó Python con Pandas para la exploración y limpieza de datos. <br ></br> El dataset original era muy sucio, con columnas mezcladas y valores inconsistentes. Se aplicó REGEX para filtrar y normalizar campos críticos como salarios y títulos de empleo. Se eliminaron outliers imposibles, como salarios mayores de 100k para posiciones de nivel inicial, y se reorganizaron y seleccionaron únicamente las columnas relevantes para maximizar la progresión salarial y la calidad laboral. Esta limpieza profesional aseguró que las métricas y visualizaciones posteriores fueran precisas y fiables.

Con SQL Server se crearon vistas optimizadas, como vw_jobs_base y Top50 Companies, para centralizar los datos limpios y calculados, facilitando la agregación por sector, compañía y localización y conservando solo la información útil para el análisis. <br />
<br />
